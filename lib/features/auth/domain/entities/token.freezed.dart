...
abstract class $TokenCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String refreshToken, int tokenExpires});
}
...
class _$_Token implements _Token {
  ...
  @override
  String toString() {
    return 'Token(accessToken: $accessToken, refreshToken: $refreshToken, tokenExpires: $tokenExpires)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, accessToken, refreshToken, tokenExpires);
...
abstract class _Token implements Token {
  factory _Token(
      ...
      required final int tokenExpires}) = _$_Token;
